    ...
    <div id="wrap">
        ...
        <header>
            ...
            <div class="container">
                <div class="top-bar">
                    <div class="open-time">
                        <p><i class="ion-ios-clock-outline"></i> Work Hours : Monday (07.15 AM - 16.15 PM)- Friday
                            (07.15 AM- 11.00 AM) </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Logo -->
            <div class="container">
                <div class="logo"> <a href="http://sandipbj.jambikota.go.id/public/"><img
                            src="<?php echo e(asset('assets/img/logo.png')); ?>" alt=""></a> </div>
                ...
                <div class="sponser-page">
                    ...
                    <div class="row">
                        <?php if(session()->has('alert')): ?>
                            <div class="col-md-12">
                                <?php echo $__env->make('includes.alert', [
                                    'type' => json_decode(session()->get('alert'))->type,
                        ...
                        <div class="col-md-12">
                            <div class="card card-user">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?php echo e(url('home/pengajuan/submit')); ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>
                                                        <h6>BAGIAN/KELURAHAN OPD *(KHUSUS DINKES, SETDA, DAN KECAMATAN)
                                                        </h6>
                                                    </label>
                                                    <select name="cabang_skpd" id="cabang_skpd" class="form-control"
                                                        required>
                                                        <option value="" selected="true" disabled="disabled">--
                                                            BAGIAN/KELURAHAN OPD --</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>
                                                        <h6>GOLONGAN DAN RUANG</h6>
                                                    </label>
                                                    <select name="pangkat_pegawai_id" id=""
                                                        class="form-control" required>
                                                        <option value="" selected="true" disabled="disabled">--
                                                            Pilih Golongan & Ruang --</option>
                                                        <?php $__currentLoopData = $data['jabatan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($row['id']); ?>"><?php echo e($row['pangkat']); ?> -
                                                                <?php echo e($row['golongan']); ?>/<?php echo e($row['ruang']); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="type_pengajuan" id="jenis_pengajuan"
                                                        class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    <label>
                                                        <h6>Nomor Telepon PA/PPKom/PPBJ </h6>
                                                    </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>
                                                        <h6>Sertifikat Pengadaan Barang/Jasa</h6>
                                                    </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pl-1">
                                                <div class="form-group">
                                                    <label>
                                                        <h6>Masa Berlaku SK</h6>
                                                    </label>
                                                    <input type="date" class="form-control datepick"
                                                        name="masa_berlaku" required data-date-format="DD MMMM YYYY">
                                                </div>
                                            </div>
                                        </div>
...
Jabatan dalam OPD : "></textarea>
                                        ...
                                        <div class="col-md-6 pl-1">
                                            <label>
                                                <h6>Lampiran SK / Surat Tugas (PDF dan Maks 2 MB)</h6>
                                            </label><br>
                                        ...
                                        <div class="col-md-6 pl-1">
                                            <label>
                                                <h6>Lampiran Tanda Tangan Yang Mengajukan(JPG dan Maks 2 MB)</h6>
                                            </label><br>
                                        ...
                                        <div class="row">
                                            <div class="update ml-auto mr-auto">
                                                <button type="submit"
                                                    class="btn btn-primary btn-round">Kirim</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <ul class="con-info">
                            <li>
                                <p> <img src="/public/assets/img/logo-footer.png">
                                    <i class="fa fa-map-marker"></i>PBJAP, Jl. Jend. Basuki Rahmat Kota Baru Kota
                                    Jambi, Jambi 36129
                                </p>
                            </li>
        ...
        <script src="<?php echo e(asset('assets/js/own-menu.js')); ?>"></script>
        ...
        <script type="text/javascript" src="<?php echo e(asset('assets/rs-plugin/js/jquery.themepunch.tools.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/rs-plugin/js/jquery.themepunch.revolution.min.js')); ?>"></script>
        ...
        <script>
          ...
          $.ajax({
              type: 'GET',
              url: "<?php echo e(url('skpd/getdata')); ?>/" + this.value,
...
<?php /**PATH /Users/perdana/Work/LaravelApp/sandipbj/resources/views/home/pages/pengajuan.blade.php ENDPATH**/ ?>