...
<div id="wrap"> 
  ...
  <header> 
    ...
    <!-- Logo -->
    <div class="container">
      <div class="logo"> <a href="http://sandipbj.jambikota.go.id/public/"><img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt=""></a> </div>
    ...
    <div class="tp-banner-container">
      <div class="tp-banner" >
        <ul>
          ...
          <!-- Slider 1 -->
          <li data-transition="fade" data-slotamount="7"> <img src="<?php echo e(asset('assets/img/slides/slide-1.png')); ?>" data-bgposition="center center" alt="" /> 
            ...
            <div class="tp-caption sft font-montserrat tp-resizeme" 
                  ...
                  style="color: #fff; font-size: 60px; text-transform: uppercase; font-weight:bolder; letter-spacing:3px;"> SANDI PBJ </div>
            ...
            <div class="tp-caption sfb  font-montserrat text-center tp-resizeme" 
                  ...
                  data-endspeed="300" 
                  data-captionhidden="on" 
                  style="color: #fff; font-size: 18px; font-weight:100; text-transform: uppercase;"> Aplikasi Layanan Akun Non Penyedia PBJ Kota Jambi <br></div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                  ...
                  data-endelementdelay="0.1" 
                  data-endspeed="300" 
                  data-captionhidden="on"> <a href="<?php echo e(url('home/pengajuan')); ?>" class="btn">Pengajuan Akun</a> &nbsp; &nbsp; &nbsp; &nbsp; <!--<a href="https://sireva.jambikota.go.id/" class="btn btn-1">Verifikasi Penyedia</a> </div>-->
          </li>

          <!-- Slider 2 -->
          <li data-transition="fade" data-slotamount="7"> <img src="<?php echo e(asset('assets/img/slides/slide-2.png')); ?>" data-bgposition="center center" alt="" /> 
            ...
            <div class="tp-caption sfb  font-montserrat text-center tp-resizeme" 
                  data-x="center" data-hoffset="0"
                  data-y="center" data-voffset="-20" 
                  data-speed="700"data-start="1500" 
                  data-easing="easeOutBack"
                  data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" 
                  data-splitin="none" 
                  data-splitout="none" 
          ...
          <!-- Slider 3 -->
          <li data-transition="fade" data-slotamount="7"> <img src="<?php echo e(asset('assets/img/slides/slide-3.png')); ?>" data-bgposition="center center" alt="" /> 
  ...
  <footer>
    <div class="container"> 
      ...
      <div class="under-footer">
        <ul class="con-info">
          <li>
            <p> <img src="<?php echo e(asset('assets/img/logo-footer.png')); ?>">
...
</html><?php /**PATH /Users/perdana/Work/LaravelApp/sandipbj/resources/views/utama.blade.php ENDPATH**/ ?>