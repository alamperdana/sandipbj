    ...
    <div class="tp-banner-container">
      <div class="tp-banner" >
        <ul>
          ...
          <!-- Slider 1 -->
          <li data-transition="fade" data-slotamount="7"> <img src="../../assets/img/slides/slide-1.jpg" data-bgposition="center center" alt="" /> 
            ...
            <div class="tp-caption sft font-montserrat tp-resizeme" 
                  ...
                  style="color: #fff; font-size: 60px; text-transform: uppercase; font-weight:bolder; letter-spacing:3px;"> SIAPESREVA </div>
            ...
            <div class="tp-caption sfb  font-montserrat text-center tp-resizeme" 
                  ...
                  data-endspeed="300" 
                  data-captionhidden="on" 
                  style="color: #fff; font-size: 18px; font-weight:100; text-transform: uppercase;"> Sistem Pengajuan Pelaku Pengadaan dan Verifikasi Penyedia <br></div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                  ...
                  data-endelementdelay="0.1" 
                  data-endspeed="300" 
                  data-captionhidden="on"> <a href="{{url('home/pengajuan')}}" class="btn">Pengajuan Akun</a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="#" class="btn btn-1">Verifikasi Penyedia</a> </div>
          </li>
        ...
        -->
          ...
          <!-- Slider 2 -->
          <li data-transition="fade" data-slotamount="7"> <img src="../../assets/img/slides/slide-2.jpg" data-bgposition="center center" alt="" /> 
            ...
            <div class="tp-caption sft font-montserrat tp-resizeme" 
                  ...
                  data-endspeed="300" 
                  data-captionhidden="on"
                  style="color: #fff; font-size: 60px; text-transform: uppercase; font-weight:bolder; letter-spacing:3px;"> SIAPESREVA </div><!-- Layer -->
            <div class="tp-caption sfb  font-montserrat text-center tp-resizeme" 
                  data-x="center" data-hoffset="0"
                  data-y="center" data-voffset="-20" 
                  data-speed="700" 
            ...
            <div class="tp-caption sfb tp-resizeme" 
                  ...
                  data-endelementdelay="0.1" 
                  data-endspeed="300" 
                  data-captionhidden="on"> <a href="#." class="btn">Pengajuan Akun</a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="#" class="btn btn-1">Verifikasi Penyedia</a> </div>
          </li>
          
          <!-- Slider 3 -->
          <li data-transition="fade" data-slotamount="7"> <img src="../../assets/img/slides/slide-3.jpg" data-bgposition="center center" alt="" /> 
