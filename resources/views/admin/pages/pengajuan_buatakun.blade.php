                    ...
                    <table class="table" id="pengajuan">
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('admin/pegawai/detail/'.$row['pegawai_id'])}}" class="btn btn-info" target="_blank"> <i class="nc-icon nc-check-2"></i> Buat Akun</a>
                                    <a href="{{url()->current().'/delete/'.$row['id']}}" class="btn btn-danger"> <i class="nc-icon nc-simple-remove"></i> Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
