        ...
        <header>
            ...
            <div class="container">
                <div class="logo"> <a href="http://sandipbj.jambikota.go.id/public/"><img
                            src="{{ asset('assets/img/logo.png') }}" alt=""></a> </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-user">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ url('home/pengajuan/submit') }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="skpd" id="skpd" class="form-control" required>
                                                        <option value="" selected="true" disabled="disabled">--
                                                            OPD --</option>
                                                        @foreach ($data['skpd'] as $row)
                                                            <option value="{{ $row['id'] }}">{{ $row['nama_skpd'] }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="pangkat_pegawai_id" id=""
                                                        ...
                                                        @foreach ($data['jabatan'] as $row)
                                                            <option value="{{ $row['id'] }}">{{ $row['pangkat'] }} -
                                                                {{ $row['golongan'] }}/{{ $row['ruang'] }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
...
Jabatan dalam OPD : "></textarea>
        ...
        <script>
          ...
          $.ajax({
              type: 'GET',
              url: "{{ url('skpd/getdata') }}/" + this.value,
